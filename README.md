...
![Tests](https://img.shields.io/badge/tests-76%20api%20%2B%20152%20benchmark%20passed-brightgreen)
...
**Status: feature-complete (Phases 0-13) and live.** 0 TypeScript errors; test counts in the badge above come from `pytest --co -q | grep -c "::"` (this repo suppresses the pytest summary line).
